...
Podcast番組「奇奇怪怪」発のカルチャープラットフォーム Flutter アプリ（v1 プロトタイプ）。

[品品団地 pinpin.tokyo](https://pinpin.tokyo/) のビジュアル・情報設計をトレースした iOS/Android フロントエンドです。

## 機能

- 回覧板 / 玉置玉稿 / 街頭テレビ / 団地ラジオ / 団地便 / 旧作倉庫 の閲覧
- 奇奇怪怪アカウント（ダミー）の作成・ログイン
